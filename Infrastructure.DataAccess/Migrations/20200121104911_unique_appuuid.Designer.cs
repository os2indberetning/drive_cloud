...
namespace Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20200121104911_unique_appuuid")]
    partial class unique_appuuid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.DomainModel.PersonReport", b =>
                {
                    b.Property<int>("PersonId");

                    b.Property<int>("ReportId");

                    b.HasKey("PersonId", "ReportId");

                    b.HasIndex("ReportId");

                    b.ToTable("PersonReport");
                });
            ...
            modelBuilder.Entity("Core.DomainModel.PersonReport", b =>
                {
                    ...
                    b.HasOne("Core.DomainModel.Report", "Report")
                        .WithMany("PersonReports")
